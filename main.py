...
MONGO_URL = MONGO_URL = "mongodb+srv://1722110607:1234@cluster0.o6f1d.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
@app.get("/pastillas/", response_model=List[Pastilla], summary="Obtener todas las pastillas", description="Devuelve una lista de todas las pastillas en la base de datos.")
async def get_pastillas():
    pastillas = await db.pastillas.find().to_list(None)
    return pastillas

@app.post("/pastillas/", response_model=Pastilla, summary="Agregar una nueva pastilla", description="Agrega una nueva pastilla con su información.")
...
@app.put("/pastillas/{nombre}", summary="Actualizar una pastilla", description="Actualiza los datos de una pastilla existente.")
...
@app.delete("/pastillas/{nombre}", summary="Eliminar una pastilla", description="Elimina una pastilla por su nombre.")
